        ...
        <div className="aspect-video bg-black">
          {embedUrl ? (
            ...
            <div className="w-full h-full flex items-center justify-center">
              <p className="text-white/70">{t('video_not_available')}</p>
            </div>
          )}
        </div>
      ...
      try {
        const demoVideos: Video[] = [
          ...
          },
          {
            ...
            channel_url: 'https://youtube.com/@rpmaster',
            duration: 1600,
            view_count: '312000',
    ...
    <>
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-4 mt-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>{t('filter_platform')}:</span>
          </div>
          ...
          <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>{t('filter_genre')}:</span>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="flex items-center gap-1 text-sm" style={{ color: 'var(--text-muted)' }}>
              {tf('live_count', { count: liveVideos.length })}
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-sm" style={{ color: 'var(--text-muted)' }}>
            {tf('videos_count', { count: regularVideos.length })}
          </span>
        </div>
