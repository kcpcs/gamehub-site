        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2" style={{ color: 'var(--text-secondary)' }}>
            {isLogin
              ...
              : 'Join GameHub to share guides and codes'}
          </p>
        </div>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4" style={{ backgroundColor: 'var(--bg-surface)', color: 'var(--text-muted)' }}>
                  or continue with
                </span>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                ...
                className="flex items-center justify-center gap-2 py-3 rounded-lg font-medium transition-all hover:scale-[1.02]"
                style={{
                  backgroundColor: 'var(--bg-raised)',
                  border: '1px solid var(--border)',
                  color: 'var(--text-primary)',
