...
export const metadata: Metadata = {
  ...
  description: 'Get active redeem codes, promo codes, and free rewards for your favorite games. Updated daily with verified codes.',
  openGraph: {
    title: 'Redeem Codes | GameHub',
    description: 'Get active redeem codes, promo codes, and free rewards for your favorite games. Updated daily with verified codes.',
    type: 'website',
    images: [
      {
        url: 'https://picsum.photos/seed/codes/1200/630',
        width: 1200,
        height: 630,
        alt: 'Redeem Codes - GameHub',
      },
    ],
  },
  twitter: {
    ...
    title: 'Redeem Codes | GameHub',
    description: 'Get active redeem codes, promo codes, and free rewards for your favorite games.',
    images: ['https://picsum.photos/seed/codes/1200/630'],
  },
}
