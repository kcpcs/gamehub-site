...
const gamesData = [
  {
    ...
    platforms: JSON.stringify(['PC', 'PS5', 'Mobile', 'Switch']),
    genres: JSON.stringify(['RPG', 'Action', 'Adventure']),
    tags: JSON.stringify(['open world', 'anime', 'gacha']),
    developer: 'miHoYo',
    publisher: 'miHoYo',
    score_opencritic: 81,
    guide_count: 5,
  ...
  },
  {
    ...
    genres: JSON.stringify(['Shooter', 'Action', 'Strategy']),
    tags: JSON.stringify(['competitive', '5v5', 'tactical']),
  ...
  },
  {
    ...
    genres: JSON.stringify(['RPG', 'Action', 'Open World']),
    tags: JSON.stringify(['souls-like', 'difficult', 'fantasy']),
  ...
  },
  {
    ...
    platforms: JSON.stringify(['PC', 'PS5', 'Xbox Series X']),
    genres: JSON.stringify(['RPG', 'Action', 'Open World']),
    tags: JSON.stringify(['cyberpunk', 'futuristic', 'story-driven']),
  ...
  },
  {
    ...
    platforms: JSON.stringify(['Switch']),
    genres: JSON.stringify(['Adventure', 'Action', 'RPG']),
    tags: JSON.stringify(['open world', 'nintendo', 'fantasy']),
    developer: 'Nintendo',
    publisher: 'Nintendo',
    score_opencritic: 96,
    guide_count: 5,
